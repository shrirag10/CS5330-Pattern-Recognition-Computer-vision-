...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.15\textwidth}
        ...
        \caption{Least sim.\\0.714}
    \end{subfigure}
    \caption{Task 7: Custom method results for \texttt{pic.0274.jpg}. Top matches
    are sequential shots (0273, 0275) from the same scene and a visually similar
    landscape (0209). The least similar image (0228) has completely different
    color and semantic content, as expected.}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.15\textwidth}
        ...
        \caption{Top 5\\0.289}
    \end{subfigure}
    \caption{Task 7: Custom method results for \texttt{pic.0893.jpg}. The top
    matches combine both color and semantic similarity. The custom method finds
    slightly different matches than pure DNN (Task 5) because color appearance
...
\begin{itemize}
    ...
    \item We used Claude (Anthropic) as an AI assistant to help with code
        structure, debugging, and report writing.
\end{itemize}
